...
Last Update: $Date: 2010-10-22 16:38:01 +0000 (Fri, 22 Oct 2010) $
Website:
Documentation:
SVN: $URL $
Dependencies: UTF8
...
ArmorSpecActive = ArmorSpecUntalented[playerClass]
...
if playerArmorType then
  ...
  local function UpdateArmorSpecActive()
    ...
    -- all pass
    ArmorSpecActive = GetPrimaryTalentTree()
  end
  -- we will schedule this since PLAYER_EQUIPMENT_CHANGED fires multiple times when you switch whole sets
...
"ADD_MANA_REG_MOD_MANA_REG_NOT_CASTING"
"MOD_AP"
"MOD_RANGED_AP"
"MOD_SPELL_DMG"
"MOD_HEAL"
  ...
  StatModTable["DRUID"] = {
    ...
    ["ADD_MANA_REG_MOD_MANA_REG_NOT_CASTING"] = {
      {
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(85101) or "").."')", -- ["Meditation"]
      },
    },
    ...
    ["MOD_AP"] = {
      ...
      },
      {
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(84735) or "").."')", -- ["Meditation"]
      },
    },
    -- Druid: Leather Specialization - Passive: 86530
    -- 4.0.1: Increases your primary attribute by 5% while wearing Leather in all armor slots.  Balance specialization grants Intellect, Feral specialization grants Agility while in Cat Form and Stamina while in Bear Form, and Restoration specialization grants Intellect.
  ...
  StatModTable["DEATHKNIGHT"] = {
    ...
    ["MOD_STA"] = {
      ...
      {-- Veteran of the Third War
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(50029) or "").."')", -- ["Veteran of the Third War"]
      },
    ...
    ["MOD_STR"] = {
      ...
      {-- Unholy Might
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(91107) or "").."')", -- ["Unholy Might"]
      },
      {-- Abomination's Might
        ["tab"] = 1,
        ["num"] = 11,
  ...
  StatModTable["HUNTER"] = {
    ...
    ["MOD_AP"] = {
      {-- Animal Handler
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(87325) or "").."')", -- ["Animal Handler"]
      },
    },
    ...
    ["MOD_AGI"] = {
      ...
      {-- Into the Wilderness
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(84729) or "").."')", -- ["Into the Wilderness"]
      },
      {-- Hunting Party
        ["tab"] = 3,
        ["num"] = 17,
  ...
  StatModTable["MAGE"] = {
    ...
    ["MOD_INT"] = {
      {-- Wizardry
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(89744) or "").."')", -- ["Wizardry"]
      },
    },
    ...
    ["ADD_SPELL_DMG_MOD_AP"] = {
      {
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(53503) or "").."')", -- ["Sheath of Light"]
      },
    },
    -- Paladin: Sheath of Light - Passive: 53503
    -- 4.0.1: Increases your spell power by an amount equal to 30% of your attack power
    ...
    ["ADD_SPELL_DMG_MOD_STR"] = {
      {
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(53592) or "").."')", -- ["Sheath of Light"]
      },
    },
    -- Paladin: Touched by the Light - Passive: 53592
    -- 4.0.1: Increases your total Stamina by 15%, increases your spell hit by 6%, and increases your spell power by an amount equal to 60% of your Strength.
  ...
  StatModTable["PRIEST"] = {
    ...
    ["MOD_INT"] = {
      {-- Mysticism
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(89745) or "").."')", -- ["Mysticism"]
      },
    },
    -- Healers: Meditation
    -- 4.0.1: Allows 50% of your mana regeneration from Spirit to continue while in combat.
    ...
    ["MOD_INT"] = {
      {-- Enlightenment
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(84732) or "").."')", -- ["Enlightenment"]
      },
    },
  }
  ...
  StatModTable["ROGUE"] = {
    ...
    ["MOD_AP"] = {
      ...
      {-- Vitality
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(61329) or "").."')", -- ["Vitality"]
      },
    },
    ...
    ["MOD_AGI"] = {
      ...
      {-- Sinister Calling
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(31220) or "").."')", -- ["Sinister Calling"]
      },
    },
  }
  ...
  StatModTable["SHAMAN"] = {
    ...
    ["ADD_SPELL_DMG_MOD_AP"] = {
      {-- Mental Quickness
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(30814) or "").."')", -- ["Mental Quickness"]
      },
    },
    -- Shaman: Mental Quickness - Passive: 30814
    -- 4.0.1: Increases your spell power by an amount equal to 50% of your attack power
  ...
  StatModTable["WARLOCK"] = {
    ...
    ["MOD_INT"] = {
      {-- Nethermancy
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(86091) or "").."')", -- ["Nethermancy"]
      },
    },
  }
  ...
  StatModTable["WARRIOR"] = {
    ...
    ["MOD_STA"] = {
      ...
      {-- Sentinel
        ...
        ["condition"] = "IsUsableSpell('"..(GetSpellInfo(29144) or "").."')", -- ["Sentinel"]
        ["new"] = 11685,
      },
    },
    -- Warrior: Plate Specialization
...
Notes:
  ...
  * stat:
  ...
  |-
  |"ADD_MANA_REG_MOD_MANA_REG_NOT_CASTING"||0||0||No
  |-
